...
class DynaMixerOperation(nn.Module):
    ...
    def __init__(self, N, D, d=18, process = 0):  # d = 2
        super().__init__()
    ...
    def forward(self, input):
        ...
        if self.process == 0:
          token_path = '/content/drive/MyDrive/MotionMixer-main/MotionMixer-main/h36m/heat_map'
          token_name = 'token_10'
          np.save(os.path.join(token_path,token_name),p_save)

        if self.process == 1:
          channel_path = '/content/drive/MyDrive/MotionMixer-main/MotionMixer-main/h36m/heat_map'
          channel_name = 'channel_22'
          np.save(os.path.join(channel_path,channel_name),p_save)
