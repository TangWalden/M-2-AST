...
class MixerBlock(nn.Module):
    def __init__(self, tokens_mlp_dim, channels_mlp_dim, seq_len, hidden_dim, activation='gelu', regularization=0,
        ...
        self.mlp_block_channel_mixing_DynaMixerOperation = DynaMixerOperation(18, self.seq_len, self.d_channel)
        ...
        self.fc_in = nn.Linear(self.hidden_dim, 18)
        self.fc_out = nn.Linear(18, self.hidden_dim)
